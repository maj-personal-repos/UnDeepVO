...
def get_stereo_image_generators(train_folder, test_folder, img_rows=128, img_cols=512, batch_size=16, shuffle=True):
    ...
    test_imagegen = ImageDataGenerator(rescale=1.0 / 255.0)
    ...
    test_generator_left = test_imagegen.flow_from_directory(test_folder,
                                                            target_size=(img_rows, img_cols),
                                                            batch_size=batch_size,
                                                            seed=10,
                                                            shuffle=shuffle,
    ...
    test_generator_right = test_imagegen.flow_from_directory(test_folder,
                                                             target_size=(img_rows, img_cols),
                                                             batch_size=batch_size,
                                                             seed=10,
                                                             shuffle=shuffle,
